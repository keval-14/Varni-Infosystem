    ...
    <div>
      <div className='technologymain text-center'>
        ...
        <div className='techimg'>
            <img src={img1} className="techlogo"></img>
            <img src={img2} className="techlogo"></img>
            <img src={img3} className="techlogo"></img>
            <img src={img4} className="techlogo"></img>
            <img src={img5} className="techlogo"></img>
            <img src={img6} className="techlogo"></img>
